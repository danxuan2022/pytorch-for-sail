...
from tools.setup_helpers.env import (  # noqa: E402
    BUILD_DIR,
    build_type,
    IS_DARWIN,
    IS_LINUX,
...
def main() -> None:
    ...
    if on_ppu:
        ...
        if use_fa in ["True", "1", "TRUE"]:
            ...
            fa_num_splits_patch = os.path.join(
                patch_root, "flash_attention_num_splits_guard.patch"
            )
            ...
            apply_patch(fa_num_splits_patch, fa_root)
