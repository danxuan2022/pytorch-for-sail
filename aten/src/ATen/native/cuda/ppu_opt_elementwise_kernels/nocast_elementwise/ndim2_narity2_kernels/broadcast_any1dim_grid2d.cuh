...
// Narrow-x variant of strip_d1a1: with size0=64 and vt=8, only 8 x lanes of the
// old 128-thread block are active. An 8x16 block parallelizes 16 output rows and
// keeps the original path's reuse of the dim1-broadcast input in shared memory.
template <int vt, typename res_t, typename arg0_t, typename arg1_t, typename func_t>
