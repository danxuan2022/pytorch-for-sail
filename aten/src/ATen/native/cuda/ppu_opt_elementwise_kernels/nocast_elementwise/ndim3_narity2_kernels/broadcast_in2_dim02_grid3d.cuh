...
// With size0=64 and vt=8, maps the original serial z loop onto block.y, keeps the
// reuse of the scalar input broadcast along dim1, and computes every output element through the real func_t.
