...
// For narrow dim0 (8 elements), folds 16 dim2 planes into block.z; enabled only at the
// larger size tiers proven effective by this round of A/B testing, and still calls the original func_t.
template <int vt, typename res_t, typename arg0_t, typename arg1_t, typename func_t>
