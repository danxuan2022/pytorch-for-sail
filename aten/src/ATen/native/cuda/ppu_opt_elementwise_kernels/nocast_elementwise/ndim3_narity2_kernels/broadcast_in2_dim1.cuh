...
// Narrow-x variant for size0=16, vt=8: unrolls the original serial y loop and z segment
// into block.y/block.z; shared IN2 preserves the cross-y reuse of the dim1-broadcast input.
