...
// Shared-memory-free tile for PCB permuted-contiguous input. Maps the wider dim1 and
// two dim2 lanes directly onto threads, deriving the remaining high-dim coordinates from
// the grid; avoids the 5D linear-index decomposition of d0s while preserving the original functor and dynamic strides.
